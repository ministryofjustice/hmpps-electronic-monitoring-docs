...
## How to run
This repo will publish to both GitHub pages and a Structurizr application. You can:
- [Run the GH pages locally](#preview-docs) at http://localhost:4567/
- [Run the structurizr repo locally](#running-locally)) at http://localhost:8080/
...
# STRUCTURIZR
## Supporting technical assurance to the EM programme

This repository captures the current outcomes of the inception phase focused around developing a shared understanding of the necessary outcomes, the users, and to define the approach to overall delivery of the EM Future Service.

### Local Interactive Server
#### Installation:
* Ensure Docker is installed on your machine ([mac instructions](https://docs.docker.com/desktop/install/mac-install/) | [windows instructions](https://docs.docker.com/desktop/install/windows-install/))
* Clone the repo and pull the docker image with the following commands:
```
git clone git@github.com:ministryofjustice/em-architecture-docs.git
cd em-architecture-docs
docker pull structurizr/lite
```

#### Running locally:
Use [Structurizr Lite](https://structurizr.com/share/76352/documentation) by running the following command in the `moj-em` folder:
...
This will allow you to you to use Structurizr website locally to view the documentation and visualisations of the current system.

### Alternatively, view the content online
Alternatively you can copy the content of the [workspace.dsl](/workspace.dsl) file into the [online renderer](https://structurizr.com/dsl) to view the visualisations of the system, and read through the markdown files in the ['workspace-docs'](/workspace-docs) folder.
